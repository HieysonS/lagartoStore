      ...
      <div className="card">
        ...
        <ul>
          <li className="iso-pro">
            ...
            <span />
            <a href="#">
              <svg className="svg bg-black fill-blue-600" viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg" >
          ...
          <li className="iso-pro">
            ...
            <span />
            <a href="#">
              <svg className="svg bg-black fill-blue-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <li className="iso-pro">
            ...
            <span />
            <a href="#">
              <svg className="svg bg-black fill-orange-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
